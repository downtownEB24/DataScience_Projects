...
-All Datasets and Models & Weights used in the code are in the Model Folder
...
Note: If for some reason your are not able to see original dataset files once unzipped, then download dataset from link above and rename the folders from download to this folder and file structure:
